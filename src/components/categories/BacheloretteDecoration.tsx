...
const BacheloretteDecoration = () => {
    const bacheloretteProducts = allDecorOptions.filter((item) => item.category === "bachelorette")
    return (
        <>
            ...
            <div className="baby-main-container container ">
                ...
                <div className="card-wrapper flex">
                    ...
                    {bacheloretteProducts.map((item) => {
                        return (
                            <BacheloretteDecorationCard key={item.slug} {...item} />
                        )
                    })}
